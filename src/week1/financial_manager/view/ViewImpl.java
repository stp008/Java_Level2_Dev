...
package week1.financial_manager.view;
...
public class ViewImpl implements View {
	...
	public void createUser(String name, String password) {
		System.out
				.println("\nUser "
						+ name
						+ " was succesfully created. Now you can use all possibilities of the app. \n");
	}

	public void put(int id, double sum, double totalSum) {
		System.out.println("\nYou have put " + sum + " on account with id "
				+ id + ". Your balance is " + totalSum + ". \n");
	}

	public void withdraw(int id, double sum, double totalSum) {
		System.out.println("\nYou have removed " + sum + " on account with id "
				+ id + ". Your balance is " + totalSum + ". \n");
	}

	public void createAccount(String description) {
		System.out.println("\nYou have created new account with description: "
